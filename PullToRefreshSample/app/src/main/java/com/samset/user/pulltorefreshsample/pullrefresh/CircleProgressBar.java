...
public class CircleProgressBar extends ImageView implements HeadListener {
    ...
    public PullProgressDrawable mProgressDrawable;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        mProgressDrawable = new PullProgressDrawable(getContext(), this);
